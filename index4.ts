...
let numArray: number[] = [2, 4, 9, 6, 7, 37, 83, 7, 2];
...
let num1Array: number[] = [2, 4, 7, 3, 5, 8, 43, 82, 93, 925, 95, 85];
...
let areaCircle: number = calculateArea(radius);
console.log(areaCircle);


// Develop a program that reads a list of grades and uses the splice method to remove failing grades (below 50) from the array.

let marks: number[] = [56, 39, 70, 60, 99, 40, 50, 82, 58, 69];

const removeGrades = (grade: number[]) => {
...
let randomArray: number[] = [20, 40, 330, 500, 534, 220, 443, 60, 220, 440];

const largestNumber = (value: number[]) => {
    let largest = value[0];
